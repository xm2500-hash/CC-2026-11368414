...
const quotes = [
  { text: "practice of combining programming techniques with artistic expression in order to create aesthetically pleasing and optimized interactive digital experiences.", 
   source: "Meadows School of the Arts" },
  { text: "a process, based on exploration, iteration, reflection and discovery, where code is used as the primary medium to create a wide range of media artifacts.", 
   source: ".timrodenbroeker" },
  { text: "a new interdisciplinary art form that bridges the gap between technologists and artists. ", 
   source: "Gorilla Sun" },
  { text: "a loosely defined term used to describe a wide range of artistic practices that use computer code as a medium. ", 
   source: "Creative Code Berlin" },
  { text: "a practice where programming is used as a tool for art or design. ", 
   source: "DigitalFUTURES" },
  { text: "practice of using computer programming as a medium for artistic and personal expression.", 
   source: "Diatom" },
  ...
  { text: "an excellent introduction to programming and graphics, and complementary to learning real-time 3D engines.", 
...
function draw() {
  background(255, 192, 203); // set the background color
